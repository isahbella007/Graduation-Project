...
<body>
 ...
 <br>
 <p><i class="fas fa-plus"></i> <a href = "addaddress.php">Add a new Address</a></p>
 <hr>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-8 col-sm-7 col-md-8">
                                 ...
                                 <br>
                            <form method = "post" action = "browserestaurant.php">
                            <input type="submit" name = "apply" class="btn btn-primary btn-xs" value = "Use">
                            <input type = "hidden" name = "post" value = "<?php echo $userAddress['addressid'];?>" class = > 
                            </form>
                            </div>
