...
if(isset($_GET['searchregion'])){
    $regionSelected =  $_GET['searchregion'];
    $getRestaurant = "SELECT * FROM restaurant Where FLAG = 'CONFIRMED' AND region = '$regionSelected' group by category";
...
<div class="container">
	<div class="row">
        ...
        <div class="col-lg-12">
            <input type="search" class="form-control" id="input-search" placeholder="Search Restaurant By Category..." >
        </div>
        <br> <br>
            ...
            <div class="items col-xs-12 col-sm-6 col-md-6 col-lg-6 clearfix">
               <div class="info-block block-info clearfix" >
                    ...
                    <table>
                       ...
                       <tr>
                           <td><button><?php echo $restaurantRes['category']?> Dishes</button></td>
                           <br>
                       </tr>
                   </table>
                    <input type="hidden" value = "<?php echo $restaurantRes['category']?>" name = "searchrestaurant">
