              ...
              <th scope='col'> Employee position</th>
				  ...
				  <tbody>";
				   ...
				   $custid = $row1['ToUser'];
				     ...
				     $sql3 = "SELECT * FROM messages INNER JOIN employee ON employee.employeeid = messages.FromUser  WHERE messages.ToUser=$resId   GROUP BY employee.employeeid  
 ;";
                     ...
                     <input type='hidden' name='orderid' value=' $row3[restaurantid]'>
