...
if(isset($_SESSION['login'])){
    ...
    $getOrders = "SELECT * from orders WHERE status = 'Accepted' AND restaurantid = '$resId' and orderdate = '$date' group by orderid ";
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-xs-8 col-sm-7 col-md-8">
                                ...
                                <form method = "GET" action = "assignkitchenstaff.php">
                                    <input type = "submit" name = "edit" value = "Assign To Kitchen Staff" class = "btn btn-primary btn-xs">
...
<?php }else{?>
    <?php echo '<script type="text/javascript">';
            echo ' alert("You have not accepted any order today")'; 
            echo '</script>';;?>
    <?php }?>