...
if(isset($_SESSION['login'])){
    ...
    if(isset($_GET['edit'])){
        ...
        $getKitchenStaff = "SELECT * FROM employee WHERE restaurantid = '$resId' AND position ='Delivery Worker' 
        ...
        if(isset($_POST['assign'])){
            ...
            $updateStatus = "UPDATE orders SET status = 'Sent for Delivery' where restaurantid = '$resId' AND orderid = '$orderId'";
...
<?php if($getKitchenStaffResult){?>
    <div class="container-fluid">
        <div class="card-body">
            <p>Choose Staff To Deliver Meal</p>
            <div class="row">
                <ul class="list-group">
                    <li>
