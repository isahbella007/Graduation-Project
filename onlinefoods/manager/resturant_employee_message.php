        ...
        <table class="table   table-bordered ">
          ...
          <tbody>   
            <?php
             ...
             $sql1 = "SELECT * FROM employee  WHERE restaurantid = $resId GROUP BY employeeid   ;";
           ...
           $empid = $row1['employeeid'];
             ...
             $sql3 = "SELECT * FROM   employee  WHERE employeeid=$empid GROUP BY employeeid  
 ;";
                     ...
                     <input type='hidden' name='cid' value=' $row3[employeeid]'>
                     <input type='hidden' name='orderid' value=' $resId'>
